package com.kuangclub.support.widget.refreshlayout;
...
/**
 * Created by Woodslake on 2018/7/30.
 */
public class SuperRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    SuperRefreshLayout.OnRefreshListener mListener;
    ...
    private SuperRefreshLayout.OnChildScrollUpCallback mChildScrollUpCallback;
     ...
     * @param attrs
     */
    public SuperRefreshLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void createFooterView(){
        mFooterView = LayoutInflater.from(getContext()).inflate(R.layout.footer_default, null);
        mFooterView.setBackgroundColor(Color.parseColor("#767776"));
        addView(mFooterView);
    }
     ...
     * gesture.
     */
    public void setOnRefreshListener(@Nullable SuperRefreshLayout.OnRefreshListener listener) {
        mListener = listener;
    }
    ...
    private void ensureTarget() {
        ...
        if (mTarget == null) {
            for (int i = 0; i < getChildCount(); i++) {
                ...
                if (!child.equals(mCircleView) && !child.equals(mFooterView)) {
                    mTarget = child;
                    break;
                }
            }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        mFooterView.layout(childLeft, childTop + childHeight - footerHeight, childLeft + childWidth, childTop + childHeight);
        child.layout(childLeft, childTop, childLeft + childWidth, childTop + childHeight - footerHeight);
    ...
    /**
     * Set a callback to override {@link SuperRefreshLayout#canChildScrollUp()} method. Non-null
     * callback will return the value provided by the callback and ignore all internal logic.
     * @param callback Callback that should be called when canChildScrollUp() is called.
     */
    public void setOnChildScrollUpCallback(@Nullable SuperRefreshLayout.OnChildScrollUpCallback callback) {
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        Log.i("onScrollChanged", "l: " + l + ", t: " + t + ", oldl: " + oldl + ", oldt: " + oldt);
    }
    ...
    /**
     * Classes that wish to override {@link SuperRefreshLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link SuperRefreshLayout#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(@NonNull SuperRefreshLayout parent, @Nullable View child);
    }
}
